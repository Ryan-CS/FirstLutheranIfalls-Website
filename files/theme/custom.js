jQuery(function ($) {
  ...
  var uniteController = {
    init: function (opts) {
      ...
      $(window).scroll(function () {
        ...
        $("body.header-scroll-animate-on .banner").css(
          "opacity",
          1 - $(window).scrollTop() / ($(".banner-wrap").height() / 1.5),
        );
        $("body.header-scroll-animate-on .banner").css(
          "top",
          (-200 * $(window).scrollTop()) / $(".banner-wrap").height(),
        );
        $("body.header-scroll-animate-on .banner").css({
    ...
    _addClasses: function () {
      ...
      $(".wsite-menu")
        .find("li.wsite-menu-subitem-wrap")
        .each(function () {
          var $me = $(this);
      ...
      $("li.wsite-menu-subitem-wrap.wsite-nav-current")
        .parents(".wsite-menu-wrap")
        .addClass("open");
    ...
    _attachEvents: function () {
      ...
      $(".splash-page .wsite-logo a").attr(
        "href",
        $(".wsite-menu-default li:first-child a").attr("href"),
      );
