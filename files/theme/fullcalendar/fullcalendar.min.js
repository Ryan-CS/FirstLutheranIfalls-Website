  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      function k(t, n) {
        ...
        for (
          i = 0;
          i < e.unitsDesc.length && ((r = e.unitsDesc[i]), !((o = V(r, t, n)) >= 1 && ut(o)));
          i++
        );
        return r;
      }
        ...
        a = (function (t) {
          ...
          return (
            ...
            (e.prototype.applyManualStandardProps = function (e) {
              ...
              return (
                !!i && ((this.dateProfile = i), null != e.date && (this.miscProps.date = e.date), n)
              );
            }),
            e
          );
    ...
    function (t, e, n) {
      ...
      function r(t, n, i) {
        ...
        var o = a.datepicker;
        o &&
          ((o.regional[n] = o.regional[t] = i), (o.regional.en = o.regional[""]), o.setDefaults(i));
      }
      function o(t, n) {
        var i, r;
          ...
          return (
            ...
            (e.prototype.processRangeUnselect = function (t) {
              ...
              this.isSelected &&
                ...
                (((e = this.opt("unselectCancel")) && r(t.target).closest(e).length) ||
                  this.unselect(t));
            }),
            (e.prototype.processEventUnselect = function (t) {
              this.selectedEventInstance &&
                (r(t.target).closest(".fc-selected").length || this.unselectEventInstance());
            }),
          ...
          return (
            ...
            (t.prototype.buildNewDateProfile = function (t, e) {
              ...
              return (
                ...
                this.forceTimed
                  ? ((o = !0), n.hasTime() || n.time(0), i && !i.hasTime() && i.time(0))
                  : this.forceAllDay &&
          ...
          return (
            ...
            (t.prototype.initAutoScroll = function () {
              ...
              ((this.isAutoScroll = this.options.scroll && t && !t.is(window) && !t.is(document)),
                this.isAutoScroll &&
                  this.listenTo(t, "scroll", r.debounce(this.handleDebouncedScroll, 100)));
            }),
            ...
            (e.prototype.updateDayTable = function () {
              for (
                var t,
                  ...
                  r = i.view,
                  o = r.calendar,
                  s = o.msToUtcMoment(i.dateProfile.renderUnzonedRange.startMs, !0),
                ...
                (r.isHiddenDay(s) ? u.push(l + 0.5) : (l++, u.push(l), d.push(s.clone())),
                  s.add(1, "days"));
        ...
        m = (function (t) {
          ...
          return (
            ...
            (e.prototype.limitRow = function (t, e) {
              ...
              if (e && e < b.segLevels.length) {
                for (
                  ...
                  if (u) {
                    for (
                      c = i[e - 1][a.leftCol], p = c.attr("rowspan") || 1, h = [], f = 0;
                      f < d.length;
                      f++
                    )
            ...
            (e.prototype.renderSegPopoverContent = function (t, e, n) {
              ...
              for (
                n = this.eventRenderer.renderFgSegEls(n, !0), this.popoverSegs = n, i = 0;
                i < n.length;
                i++
              )
                (this.hitsNeeded(),
                    ...
                    p.push(
                      r.extend({}, i, {
                        footprint: new d.default(
                          new u.default(o, i.footprint.componentFootprint.isAllDay),
            ...
            (e.prototype.getCellSegs = function (t, e, n) {
              for (
                var i, r = this.eventRenderer.rowStructs[t].segMatrix, o = n || 0, s = [];
                o < r.length;
              )
          ...
          return (
            ...
            (e.prototype.updateSize = function (e, n, i) {
              ...
              if (!this.dayGrid.rowEls)
                return void (
                  n || ((r = this.computeScrollerHeight(e)), this.scroller.setHeight(r))
                );
            ...
            (t.prototype.isEventInstanceGroupAllowed = function (t) {
              ...
              if (d)
                for (e = 0; e < i.length; e++)
                  if (
                    !1 ===
                    d(i[e].componentFootprint.toLegacy(this._calendar), i[e].getEventLegacy())
                  )
                    return !1;
              return !0;
            }),
        ...
        u = (function (t) {
          ...
          return (
            ...
            (e.prototype.buildInstances = function (t) {
              for (
                var e, n, i, r = this.source.calendar, o = t.getStart(), s = t.getEnd(), u = [];
                o.isBefore(s);
              )
        ...
        a = (function (t) {
          ...
          return (
            ...
            (e.parse = function (t, e) {
              var n;
              return (
                r.isFunction(t.events) ? (n = t) : r.isFunction(t) && (n = { events: t }),
          ...
          function e(n, i) {
            ...
            return (
              ...
              r.businessHourRendererClass &&
                r.fillRenderer &&
                (r.businessHourRenderer = new r.businessHourRendererClass(r, r.fillRenderer)),
              r
            );
          }
          return (
              ...
              return (
                this.dateProfile.activeUnzonedRange.containsDate(t)
                  ? (r.push("fc-" + a.dayIDs[t.day()]),
                    ...
                    (n = i.calendar.getNow()),
                    t.isSame(n, "day")
                      ? (r.push("fc-today"), !0 !== e && r.push(i.calendar.theme.getClass("today")))
                      : t < n
                        ? r.push("fc-past")
                        : r.push("fc-future"))
          ...
          return (
            ...
            (t.prototype.publiclyTrigger = function (t, e) {
              var n,
                ...
                o = this.opt(t);
              if (
                (r.isPlainObject(e) ? ((n = e.context), (i = e.args)) : r.isArray(e) && (i = e),
                null == n && (n = this.el[0]),
                i || (i = []),
            ...
            (t.prototype.renderView = function (t) {
              ...
              (this.freezeContentHeight(),
                ...
                !this.view &&
                  ...
                  e.startBatchRender(),
                  e.setElement(
                    r("<div class='fc-view fc-" + t + "-view' />").appendTo(this.contentEl),
                  ),
            ...
            (t.prototype.buildRangeFromDuration = function (t, e, n, s) {
              ...
              return (
                h ||
                  ...
                  l
                    ? ((u = i.duration(l)), (h = u < n ? r.computeDurationGreatestUnit(u, l) : s))
                    : (h = s)),
                n.as("days") <= 1 &&
          ...
          return (
            ...
            (e.prototype.handleMouseDown = function (t, e) {
              this.component.canStartResize(t, e) &&
                this.buildDragListener(t, r(e.target).is(".fc-start-resizer")).startInteraction(e, {
                  distance: 5,
                });
            }),
          ...
          return (
            ...
            (e.prototype.handleTouchStart = function (t, e) {
              ...
              n.canStartDrag(t, e)
                ...
                : n.canStartSelection(t, e) && this.buildSelectListener(t).startInteraction(e, i);
            }),
          ...
          return (
            ...
            (e.prototype.renderContentSkeleton = function () {
              ...
              ((e = this.contentSkeletonEl =
                r('<div class="fc-content-skeleton"><table><tr>' + n + "</tr></table></div>")),
            ...
            (e.prototype.renderNowIndicator = function (t) {
              if (this.colContainerEls) {
                ...
                for (e = 0; e < n.length; e++)
                  o.push(
                    r('<div class="fc-now-indicator fc-now-indicator-line"></div>')
                      .css("top", i)
                      .appendTo(this.colContainerEls.eq(n[e].col))[0],
                  );
                (n.length > 0 &&
                  o.push(
                    r('<div class="fc-now-indicator fc-now-indicator-arrow"></div>')
                      .css("top", i)
        ...
        c = (function (t) {
          function e(e, n) {
            ...
            return (
              ...
              (i.scroller = new l.default({ overflowX: "hidden", overflowY: "auto" })),
              i
            );
          }
          return (
            ...
            (t.prototype.render = function () {
              ...
              t
                ? (e
                    ? e.empty()
                    : (e = this.el =
                        i("<div class='fc-toolbar " + this.toolbarOptions.extraClasses + "'/>")),
                  e
            ...
            (e.prototype.buildRenderRange = function (e, n, i) {
              ...
              return (
                this.opt("fixedWeekCount") &&
                  ((r = Math.ceil(l.diff(a, "weeks", !0))), l.add(6 - r, "weeks")),
                new o.default(a, l)
              );
            }),
            e
