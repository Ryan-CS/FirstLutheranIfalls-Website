!(function (e, t) {
  ...
  function f(e) {
    if (null == e._isValid) {
      ...
      if (
        (e._strict &&
          (i = i && 0 === n.charsLeftOver && 0 === n.unusedTokens.length && void 0 === n.bigHour),
    ...
    if (e._f !== n.ISO_8601)
      if (e._f !== n.RFC_2822) {
        ...
        for (i = j(e._f, e._locale).match(N) || [], t = 0; t < i.length; t++)
          ((r = i[t]),
            (s = (h.match(le(r, e)) || [])[0]) &&
              ((a = h.substr(0, h.indexOf(s))).length > 0 && c(e).unusedInput.push(a),
  ...
  ((hn.calendar = function (e, t, n) {
    ...
    ot("en", {
      ...
      ordinal: function (e) {
        ...
        return (
          e +
          (1 === M((e % 100) / 10) ? "th" : 1 === t ? "st" : 2 === t ? "nd" : 3 === t ? "rd" : "th")
        );
      },
    }),
